...
interface IWevestIncentivesControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class IWevestIncentivesController extends BaseContract {
  ...
  interface: IWevestIncentivesControllerInterface;
