...
export type ReserveUpdatedFromMockEvent = TypedEvent<
  [BigNumber] & { revision: BigNumber }
>;

export class MockLendingPoolCore extends BaseContract {
  ...
  filters: {
    ...
    "ReserveUpdatedFromMock(uint256)"(
      revision?: BigNumberish | null
    ): TypedEventFilter<[BigNumber], { revision: BigNumber }>;
