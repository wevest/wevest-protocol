...
interface IInitializableWvLPTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IInitializableWvLPToken extends BaseContract {
  ...
  interface: IInitializableWvLPTokenInterface;
