...
/**
 * @title Wevest ERC20 WVLPToken
 * @dev Implementation of the interest bearing token for the Wevest protocol
 */
contract WvLPToken is
  VersionedInitializable,
  IncentivizedERC20('WVLPTOKEN_IMPL', 'WVLPTOKEN_IMPL', 0),
  IWvLPToken
{
  ...
  function initialize(
    ...
    _setName(wvLPTokenName);
    _setSymbol(wvLPTokenSymbol);
    _setDecimals(wvLPTokenDecimals);
  ...
  /**
   * @dev Burns wvLPTokens from `user` and sends the equivalent amount of underlying to `receiverOfUnderlying`
   * - Only callable by the LendingPool, as extra state updates there need to be managed
   * @param user The owner of the wvLPTokens, getting them burned
  ...
  /**
   * @dev Mints `amount` wvLPTokens to `user`
   * - Only callable by the LendingPool, as extra state updates there need to be managed
  ...
  /**
   * @dev Mints wvLPTokens to the reserve treasury
  ...
  /**
   * @dev Transfers wvLPTokens in the event of a borrow being liquidated, in case the liquidators reclaims the wvLPToken
   * - Only callable by the LendingPool
   * @param from The address getting liquidated, current owner of the wvLPTokens
  ...
  /**
   * @dev calculates the total supply of the specific wvLPToken
  ...
  /**
   * @dev Returns the address of the Wevest treasury, receiving the fees on this wvLPToken
   **/
  ...
  /**
   * @dev Returns the address of the underlying asset of this wvLPToken (E.g. WETH for aWETH)
   **/
   ...
   * @param target The recipient of the wvLPTokens
  ...
  /**
   * @dev Invoked to execute actions on the wvLPToken side after a repayment.
  ...
  /**
   * @dev Transfers the wvLPTokens between two users. Validates the transfer
