    ...
    case "deposit":
      {
        ...
        await deposit(reserve, amount, user, onBehalfOf, sendValue, expected, testEnv, revertMessage);
      }
      break;
    ...
    case "delegateBorrowAllowance":
      {
        ...
        await delegateBorrowAllowance(reserve, amount, rateMode, user, toUser, expected, testEnv, revertMessage);
      }
      break;
    ...
    case "repay":
      {
        ...
        await repay(reserve, amount, rateMode, user, userToRepayOnBehalf, sendValue, expected, testEnv, revertMessage);
      }
      break;
